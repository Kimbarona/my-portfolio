...
const USE_DEMO_MODE = import.meta.env.VITE_DEMO_MODE === 'true' || true;
    ...
    <section id="ai-assistant" className="ai-assistant">
      <div className="container">
        ...
        <div className="ai-info-banner">
          ...
          <span>
            {isDemoMode
              ? 'Demo mode active - Responses are pre-loaded. Deploy to Vercel with OpenAI API key for live AI responses.'
